...
printf "${BOLD}${GREEN}[?] Enter REGION (e.g. us-east4): ${NC}"
read REGION

printf "${BOLD}${GREEN}[?] Enter ZONE (e.g. us-east4-b): ${NC}"
read ZONE
...
# --- TASK 7 ---
echo -e "${CYAN}[ Task 7 ] Creating remaining instances...${NC}"
